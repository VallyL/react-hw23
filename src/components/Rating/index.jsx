...
function Rating() {
  ...
  const handleRatingByClick = (index) => {
  ...
  return (
    <div className={styles.ratingContainer}>
      ...
      ratingValue < ratingList.length ? (
        <img src={ratingList[ratingValue]} className={styles.ratingImg} />
      ) : (
      ...
      <div className={styles.buttonContainer}>
        <button
          onClick={() => handleRatingByClick(0)}
          className={styles.ratingButton}
        >
          Bad
        </button>
        <button
          onClick={() => handleRatingByClick(1)}
          className={styles.ratingButton}
        >
          Almost Good
        </button>
        <button
          onClick={() => handleRatingByClick(2)}
          className={styles.ratingButton}
        >
          Good
        </button>
        <button
          onClick={() => handleRatingByClick(3)}
          className={styles.ratingButton}
        >
          Excellent
        </button>
